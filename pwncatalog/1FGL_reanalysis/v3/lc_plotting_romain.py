...
class PulsarLightCurve:
    ...
    def plot_lightcurve( self, nbands=1, xdim=550, ydim=200, background=None, zero_sup=False,
                         ...
                         xtitle='Pulse Phase', ytitle='Counts/bin', substitute=True,Romain=True,itv=[0,1]):
        ...
        Romain        if set put a red line a each value of itv
        itv           value at which put a redline to show the off peak
        ===========   ====================================================== '''
        ...
        for N in range(nbands):
            ...
            if Romain==True:
                ...
                itv2[0]=itv[1]
                itv2[1]=itv[1]
                graphr1=TGraph(2,itv1,counts)
                graphr2=TGraph(2,itv2,counts)
                graphr1.Draw("lsame")
                graphr2.Draw("lsame")
        # ============== TEMPLATES ============== #
