...
def modify_roi(name,roi):
    ...
    def fix_gamma_cygni_region(roi):
        ...
        model = PowerLaw(index=2.42, set_default_limits=True)
    ...
    if name == 'PSRJ0034-0534':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=8.26279236249e-15, index=2.58385504461, e0=e0, set_default_limits=True))
        roi.add_source(ps)

    if name == 'PSRJ0102+4839':

        # Analysis came from $pwnpersonal/individual_sources/PSRJ0102+4839/v1/iteration_v1/run.py
        model=PowerLaw(norm=4.77276e-13, index=2.01965, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=2.6108e-13, index=1.77088, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ0106+4855':
        ...
        model=PowerLaw(norm=3.2257e-13, index=1.79886, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ0218+4232':
        ...
        model=PowerLaw(norm=7.41413e-13, index=2.16066, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ0248+6021':
        ...
        model=PowerLaw(norm=1.89676e-12, index=2.54806, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.39429e-12, index=2.39466, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=7.99365289489e-14, index=2.56703331102, e0=np.sqrt(1e2*1e5), set_default_limits=True)
        model.set_e0(e0)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=2.49074649752e-14, index=2.20958899123, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=3.96535891768e-14, index=2.35951487861, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed5', 
                       ...
                       model=PowerLaw(norm=1.75401557545e-14, index=2.35400774839, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0357+3205':
        ...
        model=PowerLaw(norm=1.50764e-12, index=2.36031, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.45817462191e-14, index=2.1079192233, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0534+2200':
        ...
        sync = PowerLaw(index=3.59, set_default_limits=True)
        sync.set_flux(6.1e-7, emin=100, emax=np.inf) 
        ic = SmoothBrokenPowerLaw(index_1=1.48, index_2=2.19, e_break=13.9e3, set_default_limits=True)
        ...
        model=PowerLaw(norm=2.06176e-12, index=2.56593, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ0610-2100':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.37549296687e-14, index=1.86277032208, e0=e0, set_default_limits=True))
        roi.add_source(ps)

    if name == 'PSRJ0613-0200':

        # Analysis came from $pwnpersonal/individual_sources/PSRJ0613-0200/v1/iteration_v1/run.py
        model=PowerLaw(norm=1.21954e-12, index=2.26465, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.24542973495e-14, index=1.89620011191, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0631+1036':
        ...
        model=PowerLaw(norm=1.36144e-12, index=2.24104, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=9.55962564961e-14, index=2.333032306, e0=np.sqrt(10*1e5), set_default_limits=True)
        model.set_e0(e0)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=1.84059647317e-12, index=2.17956292598, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=2.38824869801e-14, index=2.56059537015, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0633+0632':
        ...
        model=PowerLaw(norm=1.87896e-12, index=2.52495, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.48345e-12, index=2.20523, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.20463e-12, index=1.9803, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=2.16073773691e-14, index=2.20995284143, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0729-1448':
        ...
        model=PowerLaw(norm=2.11637e-12, index=2.33741, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2',
                       ...
                       model=PowerLaw(norm=2.65594443751e-14, index=2.14551904557, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0734-1559':
        ...
        model=PowerLaw(norm=2.39292e-12, index=2.36721, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.02789e-12, index=2.06358, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ0742-2822':
        ...
        model=PowerLaw(norm=3.53607e-13, index=1.80772, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.18032e-12, index=2.32253, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=1.27745360307e-12, index=2.36442816303, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ0751+1807':
        ...
        roi.modify(which='PSRJ0751+1807',
                   model=PowerLaw(norm=4.48e-13, index=2.28, e0=1e3, set_default_limits=True),
                   keep_old_flux=True)

    if name == 'PSRJ0835-4510':
        # Analysis came from $pwnpersonal/individual_sources/PSRJ0835-4510/v1/iteration_v1/run.py
        model=PowerLaw(norm=3.38097e-12, index=2.41688, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ0908-4913':
        ...
        model=PowerLaw(norm=1.61329e-12, index=2.21098, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=8.78234e-13, index=1.77965, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=9.08555e-13, index=1.81663, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=7.10292e-13, index=1.71194, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed5', 
                       ...
                       model=PowerLaw(norm=3.7076131973e-14, index=2.26686119207, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed6', 
                       ...
                       model=PowerLaw(norm=2.98849388238e-14, index=2.25850466269, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed7', 
                       ...
                       model=PowerLaw(norm=4.47740909044e-14, index=1.81480284629, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed8', 
                       ...
                       model=PowerLaw(norm=3.79814535525e-14, index=2.23003856044, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1023-5746':
        ...
        ps1 = PointSource(name='seed1',
                         ...
                         model=PowerLaw(norm=3.8835219935993907e-12,index=2.2310422346640504, set_default_limits=True))
        roi.add_source(ps1)
        ...
        ps2 = PointSource(name='seed2',
                         ...
                         model=PowerLaw(norm=2.787037074673656e-12,index=2.2750149645582809, set_default_limits=True))
        roi.add_source(ps2)

        # Parameters came from $pwnpersonal/individual_sources/PSRJ1023-5746/v3/v1/iteration_v1/run.py
        model=PowerLaw(norm=9.81327e-13, index=1.64754, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=2.94465169935e-14, index=2.29954918403, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1016-5857':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.14924296445e-12, index=2.00185132576, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.55632957386e-12, index=2.19992738577, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=3.65241642288e-14, index=2.11920692485, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1019-5749':
        ...
        # Analysis came from $pwnpersonal/individual_sources/PSRJ1019-5749/v1/iteration_v2/run.py
        model=PowerLaw(norm=3.71803e-12, index=2.51986, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=2.83122e-12, index=2.29234, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=2.31069e-12, index=2.37913, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=3.76182795299e-14, index=1.89696134898, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1028-5819':
        ...
        model=PowerLaw(norm=3.23885e-12, index=2.14376, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=3.35481e-12, index=2.11961, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.81777e-12, index=1.95643, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=2.87891183147e-14, index=2.57266986846, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed5', 
                       ...
                       model=PowerLaw(norm=5.65345019653e-14, index=2.25877019009, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1044-5737':
        ...
        model=PowerLaw(norm=1.45355e-12, index=1.81839, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.14890436526e-14, index=2.69098137906, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=5.58987965645e-14, index=2.37854404779, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=4.9647349951e-14, index=1.91563329088, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed5', 
                       ...
                       model=PowerLaw(norm=5.28674022223e-14, index=2.19111237861, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed6',
                       ...
                       model=PowerLaw(norm=8.30720630373e-14, index=2.27835472383, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed7',
                       ...
                       model=PowerLaw(norm=4.93545496966e-14, index=2.12308006562, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed8',
                       ...
                       model=PowerLaw(norm=5.61618504835e-14, index=2.47430711974, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed9',
                       ...
                       model=PowerLaw(norm=1.85759342156e-14, index=1.80350193598, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1048-5832':
        ...
        model=PowerLaw(norm=2.62919e-12, index=2.3449, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.13167674464e-12, index=2.58383864576, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=6.1328576585e-14, index=2.2837287097, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1057-5226':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=1.73070629043e-14, index=2.18474280097, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1105-6107':
        ...
        model=PowerLaw(norm=4.53159e-12, index=2.44334, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=5.8320279121e-12, index=2.36395151488, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1112-6103':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=5.32679272159e-14, index=2.12539171017, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=5.13524192428e-14, index=2.23376160876, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=1.52234878325e-14, index=2.43747335211, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1119-6127':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=1.16391102291e-12, index=2.29201502328, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.55707444394e-12, index=2.24782583172, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1124-5916':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=6.14897035106e-14, index=2.2847948902, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1357-6429':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=3.04615127537e-14, index=2.04884500014, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=4.08909893471e-14, index=2.31824295231, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=7.00851281392e-14, index=1.64320243565, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1410-6132':
        ...
        model=PowerLaw(norm=4.98e-12, index=2.08, e0=1000, set_default_limits=True)
        model.set_e0(e0)
        ...
        roi.modify(which='2FGL J1405.5-6121',
                   model=LogParabola(norm=6.25e-12, index=2.15, beta=0.21, e_break=1.5e+03, set_default_limits=True),
                   keep_old_flux=False)
    ...
    if name == 'PSRJ1413-6205':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.2103886838e-14, index=1.66163594909, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1420-6048':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.78103968833e-14, index=1.9303682476, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.04313642181e-14, index=1.6579090066, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1446-4701':
        ...
        model=PowerLaw(norm=1.0112e-12, index=2.33614, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=9.06513561447e-15, index=2.64423254638, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1459-6053':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.20422925696e-14, index=2.39327282263, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1509-5850':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.3726717868e-14, index=2.1205308173, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1513-5908':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=1.85739913047e-14, index=2.28455581008, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1531-5610':
        ...
        ps=PointSource(name='seed1',
                       ...
                       model=PowerLaw(norm=2.52269259203e-14, index=1.68424234239, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1600-3053':
        ...
        ps=PointSource(name='seed1',
                       ...
                       model=PowerLaw(norm=2.04297662956e-14, index=2.06408110925, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1620-4927':
        ...
        model=PowerLaw(norm=4.67995e-12, index=2.11003, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.65544415397e-12, index=2.33480583109, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1648-4611':
        ...
        model=PowerLaw(norm=1.98727e-12, index=2.44488, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=5.39900594325e-14, index=2.11105486918, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=4.1024867815e-14, index=1.86249007958, e0=e0, set_default_limits=True))
        roi.add_source(ps)


    if name == 'PSRJ1658-5324':
        # Analysis came from $pwnpersonal/individual_sources/PSRJ1658-5324/v1/iteration_v1/run.py
        model=PowerLaw(norm=7.25394e-13, index=1.9179, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.43796e-12, index=2.38295, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=6.25471e-12, index=2.25546, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=3.27541586467e-12, index=2.40057243748, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1702-4128':
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=1.17225189366e-13, index=2.11438552533, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1709-4429':
        ...
        roi.modify(which='2FGL J1704.9-4618',
                   ...
                   model=PowerLaw(
                       ...
                       e0=1000.0, set_default_limits=True))
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=4.32852254873e-14, index=2.36455250515, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=5.23731553365e-14, index=1.55724241688, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=3.6239366048e-14, index=2.38679064814, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=5.77450257251e-14, index=2.17762318631, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1718-3825':
        ...
        model=PowerLaw(norm=1.06204e-12, index=1.56099, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.57463439345e-14, index=2.26689639259, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1730-3350':
        ...
        roi.modify(which='2FGL J1737.2-3213',           
                   model=LogParabola(norm=1.17e-12, index=2.99, beta=0.571, e_break=2.16e+03, set_default_limits=True),
                   keep_old_flux=False)
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=3.24541432392e-14, index=2.20499173648, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.21402572576e-14, index=2.11673746506, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=2.74612884963e-14, index=2.19630876064, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=6.45739424905e-14, index=2.05619573423, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1732-3131':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=1.13790137991e-13, index=2.01834916389, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=7.0411134277e-14, index=1.843382924, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=6.04948228472e-14, index=1.81567949427, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1741-2054':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=8.23927076985e-14, index=2.0172897423, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.89984677103e-14, index=2.26787357201, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1744-1134':
        ...
        model=PowerLaw(norm=1.72388137017e-13, index=2.27483263865, e0=np.sqrt(1e2*1e5), set_default_limits=True)
        model.set_e0(e0)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.56240866791e-14, index=2.19083839165, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1746-3239':
        ...
        ps = PointSource(name='seed1',
                         ...
                         model=PowerLaw(norm=3.2270327105385296e-12,
                                        index=2.1855137088271537, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.51982240786e-12, index=2.00499887044, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=4.15747134896e-14, index=2.22310569138, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=4.84289509895e-14, index=1.94338964805, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1747-2958':
        ...
        ps = PointSource(name='seed1',
                         ...
                         model=PowerLaw(norm=4.54e-12,
                                        index=2.20, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.89755082789e-14, index=2.65471474759, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1747-4036':
        ...
        model=PowerLaw(norm=5.31456e-13, index=1.8748, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.67915426712e-14, index=2.28139568381, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1801-2451':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=8.37060551567e-14, index=1.99876650994, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.73437154305e-14, index=1.9527142892, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=3.32828348763e-14, index=2.28861657031, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1809-2332':
        ...
        model=PowerLaw(norm=2.40015523271e-13, index=2.51029888415, e0=np.sqrt(1e2*1e5), set_default_limits=True)
        model.set_e0(e0)
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=9.98029549858e-14, index=1.91465083972, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1810+1744':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=1.74396681577e-14, index=2.26238985693, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1823-3021A':
        ...
        ps=PointSource(name='seed1',
                       ...
                       model=PowerLaw(norm=1.44678749683e-14, index=2.90225670983, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2',
                       ...
                       model=PowerLaw(norm=2.99460008569e-14, index=1.87219474918, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1826-1256':
        ...
        ps=PointSource(name='seed1',
                       ...
                       model=PowerLaw(norm=4.2159239189e-14, index=2.09900040555, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1833-1034':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=6.33563253524e-14, index=1.90201589085, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=9.56493141083e-14, index=2.18407833596, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=8.10025554682e-14, index=2.42976385092, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1835-1106':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=1.81795866627e-12, index=2.33701941988, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=1.75855512547e-14, index=2.76743387939, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=1.28025066491e-13, index=1.9692153112, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=2.03308486715e-14, index=2.51890044978, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1846+0919':
        ...
        model=PowerLaw(norm=4.81421e-12, index=2.27118, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.13635564381e-13, index=2.3528111204, e0=np.sqrt(1e2*1e5), set_default_limits=True)
        model.set_e0(e0)
        ps=PointSource(name='seed2', 
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=6.1493696327e-14, index=2.14461517853, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1907+0602':
        ...
        model=PowerLaw(norm=2.94694e-12, index=2.23247, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=5.58261057897e-12, index=2.23253027573, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1939+2134':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=3.84339719761e-14, index=1.7707891594, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.84142283976e-14, index=2.36294672893, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ1952+3252':
        ...
        model=PowerLaw(norm=3.64908e-12, index=2.64963, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ1959+2048':
        ...
        model=PowerLaw(norm=2.67284e-12, index=1.97096, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.42676588842e-12, index=1.87448790915, e0=1000.0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2017+0603':
        ...
        model=PowerLaw(norm=5.97897e-13, index=1.97357, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ2028+3332':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=3.01380042617e-14, index=2.34411651063, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2030+4415':
        ...
        model=PowerLaw(norm=4.0005e-12, index=2.48727, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ2032+4127':
        ...
        model=PowerLaw(norm=2.31436226763e-13, index=2.34156498732, e0=np.sqrt(1e2*1e5), set_default_limits=True)
        model.set_e0(e0)
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.41212028323e-14, index=2.23815362813, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2030+3641':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=5.28859248803e-14, index=2.14552826137, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2043+2740':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=2.79509818749e-14, index=1.77812764818, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.48611304736e-14, index=2.31665074171, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2055+2539':
        ...
        model=PowerLaw(norm=1.47473e-12, index=2.28808, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.20072761889e-14, index=2.42619077228, e0=e0, set_default_limits=True))
        roi.add_source(ps)


    if name == 'PSRJ2111+4606':
        # Analysis came from $pwnpersonal/individual_sources/PSRJ2111+4606/v1/iteration_v1/run.py
        model=PowerLaw(norm=7.72022e-13, index=1.82989, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ2124-3358':
        ...
        model=PowerLaw(norm=8.87418e-13, index=2.13046, e0=1000, set_default_limits=True)
    ...
    if name == 'PSRJ2229+6114':
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=2.04179263063e-14, index=2.34891447256, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2238+5903':
        ...
        ps=PointSource(name='seed1', 
                       ...
                       model=PowerLaw(norm=4.06542997682e-14, index=2.39895770087, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed2', 
                       ...
                       model=PowerLaw(norm=3.23249581438e-14, index=1.99253978427, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=3.92884766064e-14, index=1.58638784179, e0=e0, set_default_limits=True))
        roi.add_source(ps)
    ...
    if name == 'PSRJ2240+5832':
        ...
        model=PowerLaw(norm=2.91961e-13, index=1.41685, e0=1000, set_default_limits=True)
        ...
        model=PowerLaw(norm=1.82781e-12, index=2.48384, e0=1000, set_default_limits=True)
        ...
        ps=PointSource(name='seed3', 
                       ...
                       model=PowerLaw(norm=5.1058917963e-14, index=1.86803437427, e0=e0, set_default_limits=True))
        roi.add_source(ps)
        ...
        ps=PointSource(name='seed4', 
                       ...
                       model=PowerLaw(norm=1.98311268884e-14, index=2.49685926985, e0=e0, set_default_limits=True))
        roi.add_source(ps)
...
def cutoff_model0(name):
    ...
    if name == 'PSRJ1112-6103':
        ...
        pl=PowerLaw.from_gtlike(
            Index=-1.8585297189701677, 
            Prefactor=1.1913729223359034e-13,
            Scale=e0,
            set_default_limits=True)
