...
\tabref{all_energy} shows the results of the all energy analysis of the off-peak emission for each pulsar.

\tabref{each_energy} shows the results of the analysis in separate energy bins of each pulsar.

\tabref{cutoff_test} shows the results of the cutoff test for pulsars with significant low-energy emission.
...
The localization results are in \tabref{localization}
...
\figref{variability} shows the cutoff test\ldots
