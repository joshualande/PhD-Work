...
\begin{sidewaystable}
    \begin{centering}
      \begin{tabular}{l|rrrrrrrrrr}
        ...
        \hline
        MSH 15-52            &     320.38\deg &      -1.22\deg & $  0.20\deg \pm   0.06\deg$ &       75.2 &        7.2 &   0.03\deg & $    0.6 \pm     0.7$ & $   2.26 \pm    0.73$ &                      \\
        HESS J1825-137       &      17.56\deg &      -0.46\deg & $  0.65\deg \pm   0.07\deg$ &       81.6 &       51.4 &   0.05\deg & $    1.8 \pm     0.1$ & $   1.74 \pm    0.06$ &                      \\
      \end{tabular}
      ...
      is the edge of the best fit uniform disk spatial model.  PosErr
...
\begin{figure}
  \begin{center}
    ...
    \end{center}
    \caption{The cumulative density of \tsext for 775 of the
    clean AGN in 2LAC which are significant above 1 \gev.
    AGN are expected to be unresolvable so overlaid on this plot
    is a $\chi^2/2$ distribution suggested by Wilk's theorem (see
    section~\ref{monte_carlo_validation}).  The \tsext distribution
    computed with \pointlike agrees with Wilk's theorem which confirms
    that we can use \tsext as a calibrated test of extension. The
    distribution computed by \gtlike is biased towards smaller values of
    \tsext. This is because \tsext is optimized using \pointlike and minor
    difference in the \pointlike and \gtlike likelihood function will
    cause the best fit value between these two methods to differ. Because
    \gtlike's curve lies to the left of the theoretical distribution,
    requiring that \tsext is significant with both methods makes this
    test for extension conservative.  Two sources had $\tsext>9$.  One was due to incorrectly
    pruning a nearby catalog sources and the other was due to failure
    of convergence of the point hypothesis.  More information about this
    analysis is presented in section~\ref{test_1lac_sources}.
    }\label{agn_ts_ext}
  \end{figure}
...
\begin{sidewaystable}
  \begin{centering}
    \begin{tabular}{l|rrrrrrrrrr}
      ...
      2FGL\,J1632.4-4753c  &     336.41\deg &       0.22\deg & $  0.44\deg \pm   0.04\deg$ &      127.8 &       64.5 &   0.04\deg & $    1.9 \pm     0.2$ & $   2.29 \pm    0.21$ &      HESS\,J1632-478 \\
      2FGL\,J1837.3-0700c  &      25.08\deg &       0.13\deg & $  0.35\deg \pm   0.08\deg$ &       46.2 &       18.8 &   0.07\deg & $    1.0 \pm     0.2$ & $   1.63 \pm    0.29$ &      HESS\,J1837-069 \\
      2FGL\,J2021.5+4026   &      78.18\deg &       2.19\deg & $  0.59\deg \pm   0.03\deg$ &      222.2 &      116.4 &   0.04\deg & $    1.8 \pm     0.2$ & $   2.31 \pm    0.19$ &          Gamma Cygni \\
      \hline
  \end{tabular}
    ...
    The quoted flux is in units of
      $10^{-9}\ph/\cm^2/\sec$ and is the flux in the fit energy range
      (either 1 \gev to 100 \gev or 10 \gev to 100 \gev)
...
\begin{figure}
  \begin{center}
    ...
    associated with extended \tev sources.  The black points
    with circular markers are the LAT data points. The red points
    with dashed markers are H.E.S.S points of associated sources.
    Plot (a) shows the \gev SED of 2FGL\,J1615.0-5051
    and the \tev SED of HESS\,J1616-508.  Plot (b) shows
    the \gev SED of 2FGL\,J1615.2-5138 and \tev the SED of HESS\,J1614-518
    Plot (c) shows the \gev SED of 2FGL\,J1632.4-4753c
    and the \tev SED of HESS\,J1632-478. Plot (d) shows the
    \gev SED of 2FGL\,J1837.3-0700c and the \tev SED of HESS\,J1837-069.
    The H.E.S.S. data points are from (\cite{hess_plane_survey}).
    Both LAT and H.E.S.S. spectral errors are systematic only.
    }\label{hess_seds}
  \end{figure}
...
\begin{figure}
  \begin{center}
    ...
    the LAT size is not converted to \rsixeight but the disk extension is
    directly compared.  This plot shows that there is good correlation
    between the \gev and \tev sizes of sources.  The \tev size of MSH
    15-52, HESS J1614-518, HESS J1632-478, and HESS J1837-069 have only
    been reported with an elliptical Gaussian fit and so the plotted size
    of these sources is the average of the radius in the semi-major and
    semi-minor axis.
