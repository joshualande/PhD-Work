...
to the square root of the relative exposures and is caused by Poisson fluctuations in the background.
...
diffuse emission in the region. Nevertheless, 
this alternative approach to modeling the diffuse emission
does not test all systematics related to the diffuse emission model.
In particular, because the alternative approach uses the same underlying gas
maps it is unable to be used to assess systematics due to mischaracterization of local
