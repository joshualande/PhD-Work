...
a radially symmetric uniform and Gaussian surface brightness of size 0.5\deg.\footnote{To
...
axes when fitting the source with an elliptical Gaussian surface 
brightness.
...
of $0.35\deg\pm0.08\deg_\stat\pm0.03\deg_\sys$ 
with an extension
...
surface brightness.  This corresponds to a 68\% containment radius of
...
As figure~\ref{time_sensitivity} showed, our sensitivity to these smaller
sources will actually improve faster than $\sqrt{t}$.
...
\begin{figure}
  \begin{center}
    ...
    surface brightness models when smoothed by the PSF look similar.  The $y$
...
\begin{sidewaystable}
    \begin{centering}
      ...
      list are the extended sources analyzed using 1-100 \gev photons.  
      The lower table are the sources
      analyzed using 10-100 \gev photons.
      ...
      \tsext was computed with \gtlike assuming the best fit radially
      symmetric uniform surface brightness from \pointlike.  \glon and \glat are Galactic
      longitude and latitude of the best fit extended source respectively.
      $\sigma$ is the edge of the best fit radially
      symmetric uniform surface brightness model.
      ...
      Lobes were not fit by our analysis but are include for completeness
...
\begin{figure}
  \begin{center}
    ...
    in section~\ref{test_2lac_sources}.
    }\label{agn_ts_ext}
  \end{figure}
...
\begin{sidewaystable}
    \begin{centering}
      ...
      flux is measured in units of $10^{-9}\ph/\cm^2/\sec$ and is either
      the 1-100 \gev or 10-100 \gev photon flux.
      }
...
\begin{figure}
  ...
  this source assuming a radially
  symmetric uniform surface brightness.  The light
