...
effective area ($\sim 8000\ \cm^2$ at $>1 \gev$).  Using two years of
all-sky surveying data, the LAT Collaboration published a catalog of 1873
sources detected at these \gev energies called 2FGL \citep{second_cat}.
...
On the other hand, the capability to spatially resolve \gev $\gamma$-ray
...
emission model, the galactic emission was scaled by a unitless power-law
...
in Figure~\ref{four_plots_ic443}.  For each source, we also made
diffuse-emission-subtracted smoothed counts
maps. Figure~\ref{four_plots_ic443} also shows an example for IC443.
...
Figure~\ref{2FGL_J1712.4-3941} overlays H.E.S.S. \tev contours of SNR RX
...
\tablecomments{
    the spectral models used in the Monte Carlo simulations used to
    validate of \pointlike.
...
\begin{figure}
  ...
  a 0\fdg25 2D Gaussian kernel and (b) also the emission 
...
\begin{figure}
  ...
  (a)
  the region around 2FGL\,J1837.3-0700c smoothed by a 0\fdg1 2D Gaussian
...
\begin{figure}
  ...
  because it is part of the extended source.  The diamond
...
\begin{figure}
    ...
    J1713.7-3946 Vela Jr., the \tev sources were fit assuming a 2D Gaussian
