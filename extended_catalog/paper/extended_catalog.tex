...
%   -> Significantly expanded the section with a new
%      monte carlo study fitting extended sources as
%      two point sources, and vice versa
%
% * replace all occurances of ts_inc with ts_2pts
%%%%%%%%
...
% * Add AGILE Gamma Cygni Pulsar citation.
...
we define here the source size (0\fdg5) 
...
analyzed only in the 10 \gev to 100 \gev energy range.
...
and \tev contours are 
overlaid on Figure~\ref{1FGL_J1613.6-5100c} \citep{hess_plane_survey}.
H.E.S.S. measured an
extension $0\fdg136\pm0\fdg008$ when fitting this source with an elliptical
2D Gaussian surface brightness.  This corresponds to a 68\% containment
radius of $\rsixeight=0\fdg21\pm0\fdg01$, comparable to the LAT
size $\rsixeight=0\fdg27\pm0\fdg03$.
Figure~\ref{hess_seds} shows that the spectrum of 2FGL\,J1615.0$-$5051
at \gev energies
also connects smoothly to the spectrum of HESS\,J1616$-$508 at \tev
energies.
...
\citep{discovery_of_PSR_J1617-5055,integral_HESS_J1616-508}.
Only PSR\,J1617$-$5055 is energetically capable of powering the
\tev emission
and
\cite{hess_plane_survey} speculated that 
HESS\,J1616$-$508 could be 
a PWN powered by this young
pulsar.
Because HESS\,J1616$-$508 is $9\arcmin$ away from PSR\,J1617$-$5055, this would
require an asymmetric X-ray PWNe to power the \tev emission. 
\chandra ACIS observations revealed an underluminous PWN of
size $\sim1\arcmin$ around the pulsar that was not oriented
towards the \tev emission rendering this association uncertain
\citep{discovery_of_pwn_for_PSR_J1617-5055}.  No other promising
counterparts were observed at X-ray and soft gamma-ray energies
by \suzaku \citep{suzakzu_HESS_J1616-508}, \swiftxrt,
...
understand this $\gamma$-ray source.
...
\begin{figure}
    ...
    \caption{
    The LAT's projected detection threshold to extension after a ten-year exposure
    for a power-law
    ...
    (dashed line colored blue). The solid gray regions represent the
...
\begin{figure}
  ...
  \caption{A diffuse-emission-subtracted 10 \gev to 100 \gev counts map of
  2FGL\,J1632.4$-$4753c smoothed by a 0\fdg1 2D Gaussian
  kernel.  The triangular marker (colored red in the electronic version)
  represents the 2FGL position of this source.  The plus-shaped marker
  and the circle (colored red) are the best fit position and extension of
...
\begin{figure}
  ...
  region around 2FGL\,J1837.3$-$0700c (a) smoothed by a 0\fdg1 2D Gaussian
