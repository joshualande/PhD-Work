...
and two different energy bands (1 \gev to 100 \gev and 10 \gev to
...
publication by the LAT Collaboration about W30 is still in preparation.}
\gev emission from W30 was also studied in \cite{castro_and_slane_2010}.
Using 1 \gev to 100 \gev photons, our analysis significantly detected
...
\tablecomments{
    A list of the spectral models of the simulated point sources
    ...
    also tabulated.  The models spans representative spectral parameters.
}
\end{deluxetable}
...
\tablecomments{
      ...
      sources for a two-year exposure
      for sources of varying energy
...
\begin{figure}
    ...
    AGN in 2LAC which are significant above 1 \gev calculated with \pointlike (dashed line
...
for the two point source hypothesis test 
...
\begin{figure}
  ...
  of the region around 2FGL\,J0823.0$-$4246 smoothed by a 0\fdg1 2D
  ...
  The lower right inset is the model predicted emission from a point
...
\begin{figure}
  ...
  \caption{A diffuse-emission-subtracted 1 \gev to 100 \gev counts map
  of the region around 2FGL\,J1712.4$-$3941 (a) smoothed by a 0\fdg25 2D
  ...
  and was recently reported by \cite{rx_j1713_lat}.  The triangular marker
  (colored red in the online version) represents the 2FGL position of this
  source.  The plus-shaped marker and 
  the circle (colored red) are the best fit position
  and extension of this source assuming a radially symmetric uniform
  surface brightness.  The contours (colored light blue) correspond
  to the \tev image \citep{rx_j1713_hess}.  The region was analyzed
  with the same background model as \cite{rx_j1713_lat}. Source A is
  coincident with 2FGL\,J1715.4$-$4024c and the circular and square-shaped
  marker
  (colored blue) represent the 2FGL and relocalized position of this
  source respectively.  The diamond-shaped markers
  (colored purple) represent
  the position of source B and C that were added to the background model.
...
\begin{figure}
  ...
  the region around 2FGL\,J0851.7$-$4635 smoothed by a 0\fdg25 2D Gaussian
...
\begin{figure}
  ...
  \caption{A diffuse-emission-subtracted 10 \gev to 100 \gev counts map of
  the region around 2FGL\,J1632.4$-$4753c smoothed by a 0\fdg1 2D Gaussian
  kernel.  The triangular marker (colored red in the electronic version)
  represents the 2FGL position of this source.  The plus-shaped marker
...
\begin{figure}
    ...
    with circular markers are the LAT data points. The points with
    dashed markers (colored red in the electronic version) are the
    H.E.S.S points of the associated sources.  Plot (a) shows the
    LAT SED of 2FGL\,J1615.0$-$5051 together with the H.E.S.S. SED
    of HESS\,J1616$-$508.  Plot (b) shows 2FGL\,J1615.2$-$5138
    and HESS\,J1614$-$518. Plot (c) shows 2FGL\,J1632.4$-$4753c
    and HESS\,J1632$-$478. Plot (d) shows 2FGL\,J1837.3$-$0700c
