...
2FGL J1856.2+0450c fits to a very large extension of 1.37\deg and the result is
...
\todo[inline]{Can we get another citation about dark gas
and stuff?
Better note about spectral index being typical of difuse emission.
Also does this description make sense? Also, is 
citation about IRAS good?}
...
Improve the point about how since the source is soft, it
is more consistent with diffuse emission.
}
...
% Modify 
%  * P72Y2472 - 2FGL J1615.0-5051 - SkyDir(332.365,0.005,SkyDir.GALACTIC)
% New source
%  * SkyDir(332.426,-0.331,SkyDir.GALACTIC
...
\todo[inline]{Describe contours overlaid on source}
...
\todo[inline]{
This source is the Gamma Cygni SNR!
...
Describe contours overlaied on source}
...
\todo[inline]{explain that Vela Jr will be described better in upcoming publication}
\todo[inline]{Describe contours overlaid on source}
...
\begin{figure}
  \begin{center}
    ...
    that for sources neither very large nor soft, our sensitivity is
...
\begin{sidewaystable}
    \begin{centering}
      \begin{tabular}{r|rr|rrrr|rrrr}
        ...
        2FGL J0851.7-4635    &       17.2 &       90.9 &     266.79\deg &      -1.32\deg & $       0.2 \pm        0.1$ & $  1.8 \pm   0.5$  &     266.41\deg &      -1.38\deg & $       0.2 \pm        0.1$ & $  1.5 \pm   0.6$ \\
        \hline
      \end{tabular}
  ...
  \begin{sidewaystable}
    \begin{centering}
      ...
      same model but fitting with \gtlike.  There is very good agreement
...
1FGL J1613.6-5100c
%P72Y2473
  \todo[inline]{Describe this source better. Describe the Contour}
...
2FGL J0851.7-4635
  ...
  P72Y1287. 
  Using $E>10\gev$. 
  \todo[inline]{Note that source is convolved with a $0.25\deg$ gaussian
  which is different than other plots.}
  \todo[inline]{Describe this source better. Describe the Contour}
  }\label{Vela_Jr}
\end{figure}
