...
sky since 2008 June.  The LAT has a broad energy coverage (20 \mev to $>300$
...
$\sim0\fdg1$ to $\sim0\fdg25$ \citep{hess_plane_survey}.
In fact, within
...
hadronic cosmic rays up to $\sim 10^{15}$ eV and subsequently radiate
...
and the 68\% containment radius of the PSF is approximately $5\fdg1$
...
by the granularity of the silicon strips and is $0\fdg14$ at 10 \gev
...
\begin{figure}
  \begin{center}
    \includegraphics{ic443_plots/four_plots_ic443.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{mc_plots/compare_disk_gauss.eps}
    % this plot came from /u/gl/lande/work/fermi/extended_catalog/2FGL/plots_for_paper/compare_disk_gauss/v2/plot.py
    \end{center}
    \caption{
    ...
    is the brightness profile of a Gaussian with $\rsixeight=0\fdg5$.
    The dashed blue line is the brightness profile for a uniform disk
    with $\rsixeight=0\fdg5$.  The solid red and blue lines show the
...
\begin{figure}
  \begin{center}
    \includegraphics{mc_plots/ts_ext_emin_1000.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{mc_plots/index_sensitivity.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{mc_plots/all_sensitivity.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{mc_plots/time_sensitivity.eps}
    ...
    year threshold by the square root of time (top edge) and linearly with
    ...
    improves by a factor better than the square root of time. 
    }
...
\begin{figure}
  \begin{center}
  \includegraphics{ic443_plots/res_tsmap_ic443.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{source_plots/example_bad_fit.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{source_plots/agn.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_1FGL_J0823.3-4248}
  \end{center}
  % this plot came from 
  % /u/gl/lande/work/fermi/extended_catalog/2FGL/plots_for_paper/source_plots/1FGL_J0823.3-4248/v7/source_1FGL_J0823.3-4248.pdf
  \caption{A diffuse-emission-subtracted 1-100
  \gev counts map of the region around 2FGL\,J0823.0-4246 smoothed
  by a 0\fdg1 Gaussian kernel.  The red star is the 2FGL position
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_1FGL_J1628.6-2419c}
  \end{center}
  % this plot came from 
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_RX_J1713.7-3946}
    % this plot came from
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_Vela_Jr}
  \end{center}
  % this plot came from 
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_1FGL_J1613.6-5100c}
  \end{center}
  % this plot came from 
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_1FGL_J1632.9-4802c}
  \end{center}
  % this plot came from 
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_1FGL_J1837.5-0659c}
  \end{center}
  % this plot came from 
...
\begin{figure}
  \begin{center}
    \includegraphics[type=eps,ext=.eps,read=.eps]{source_plots/source_Gamma_Cygni}
  \end{center}
  % this plot came from 
  ...
  red star is the 2FGL position of 2FGL J2021.5+4026.  The red cross
...
\begin{figure}
  \begin{center}
    \includegraphics{summary_plots/snr_seds.eps}
    ...
    (2FGL\,J2021.5+4026) which are coincident with SNRs.
    The red line is the best fit power-law spectral model.
...
\begin{figure}
  \begin{center}
    \includegraphics{summary_plots/hess_seds.eps}
    ...
    are from \citep{hess_plane_survey} Both LAT and H.E.S.S. spectral errors are
    statistical only.}
    \label{hess_seds}
  \end{figure}
...
\begin{figure}
  \begin{center}
    \includegraphics{summary_plots/allsky_extended_sources.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{summary_plots/gev_vs_tev_plot.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{summary_plots/gev_vs_tev_histogram.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics{summary_plots/compare_index_2FGL.eps}
