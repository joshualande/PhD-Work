...
leads to the often quoted result $\sqrt{TS}=\sigma$. It is plausible
...
spectral index $\sim2.4$ and an extension $\sigma=\sim0\fdg35$, 
...
sizes ($\sigma\sim0\fdg5$), one can often obtain almost as large
...
\gev and 100 \gev where the PSF is larger.  
On the other hand,
when testing the two simulated point-like sources for extension our test
found that \tsinc was larger than \tsext.
...
point-like source and an extended source.  The residual test statistic
map indicates
...
$\sigma=0\fdg32\pm0\fdg04_\stat\pm0\fdg01_\sys$ 
\tsext=16.7.  
...
\begin{figure}
    ...
    that would be considered as extended.
    }
