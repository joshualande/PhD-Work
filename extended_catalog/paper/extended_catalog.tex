...
% XXXXXXXXXXXX describe how \pointlike calculates extension errors and how localization errors are calculated.

% XXXXXXXXXXXX note about how \pointlike is written in python = more flexible
...
% XXXXXXXXXXXXXXXXXXX NOTE ABOUT gtlike crosscheck
...
% XXXXXXXXXXXXXXX \tsinc vs \tsext NOT A CALIBRATED TEST
% but still suggestive in the cases \tsinc \ll \tsext and
% \tsinc \gg \tsext.
...
% XXXXXXXXXXXXXXXX better description of how TSext is always > 0
% but wilk's thorem says that it won't be must better if the source
% is a point source
