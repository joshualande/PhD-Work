...
source becomes larger and more negative when the two point-like sources
are farther apart.
...
test from \pointlike, \gtlike, and \gtlike with the alternative diffuse
model respectively.  $\sigma$, $\sigma_\altdiff$, and $\sigma_\altpsf$
are the fit size assuming
a uniform radially symmetric intensity distribution
with the standard analysis, the alternative diffuse
model, and the alternative PSF respectively.  \tsinc is the test statistic
