...
source candidates, table~\ref{alt_diff_model_results} shows a
...
both \pointlike and \gtlike.  For the new extended source candidates,
table~\ref{alt_diff_model_results} shows a comparison of of \tsext for
