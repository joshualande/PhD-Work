...
here. Should we report the total number of extended sources instead of the
number of new sources???} new extended sources.
\end{abstract}

\section{Introduction}

\todo[inline]{Add note about how difficult lat analysis in
the galactic plane is because of large PSF, low statistics,
and high source density. Describe how it requires a certain amount
of iterative, by eye modifying of the sky model. Not
adequate to simply use 2FGL}
...
\todo[inline]{Add note about how we had to delete nearby sources which
were not hard above 10 \gev for analysis to converge.}
...
As an example of why this issue, we describe our test of 
2FGL J1856.2+0450c for
...
emission subtracted.  A two year catalog source 
2FGL J1856.2+0450c was found at the
...
2FGL J1856.2+0450c fits to a large extension of 1.37\deg and the result is
...
\todo[inline]{Give some additional interpretation of the Puppis A SNR.}
...
Better note about spectral index being typical of difuse emission.
...
\todo[inline]{this needs more quantification/description.  Improve the
point about how since the source is soft, it is more consistent with
diffuse emission.}
...
\todo[inline]{
Add a better interpreation.
Explain that Vela Jr will be described better in upcoming publication???
}
...
% Same modifications as 2FGL J1615.0-5051.
...
%is coincident with the one year catalog source 1FGL J1614.7-5138c.
...
%the nearby catalog sources 2FGL J1620.6-5111c, 2FGL J1619.7-5040c,
...
%J1615.2-5138 until a stable fit was found.  
...
%This extended source is spatially coincident with the extended source
%HESS J1614-518 which was reported in the H.E.S.S. survey of the Inner
%Galaxy (\cite{HESS_plane_survey}). Overlaid on figure~\ref{1FGL_J1613.6-5100c} are the H.E.S.S
%contours of this source and it can be seen that there is good spatial
%overlap between the LAT and H.E.S.S. emission.
%
%It is unclear if our model around the nearby souce 2FGL J1615.0-5051
%is good. 2FGL J1615.0-5051 is spatially coincident with the extended H.E.S.S.
%source HESS J1616-508 but was not found to be significantly extended
%with our extended source search.
%
%It is unclear if this new source is physically real.
%2FGL J1615.0-5051 fit $\ts=28$ and the added source had $\ts=12$
%which is not extended.
%2FGL J1615.0-5051 was not found to be significantly extended.
%$\ts=12$ which is not significant. 
%
%It is unclear of this new seed
...
\todo[inline]{Describe contours overlaied on source}
...
\todo[inline]{Describe the interpretation of this source}
...
\todo[inline]{
Near HESS source HESS J1837. 
Discuss the upcomming publication???}
...
\todo[inline]{
Add more interpreation about this source. Describe how this source
will be more carefully analyzed in the paper
...
\begin{figure}
  ...
  \todo[inline]{This figure could better explain the source}
...
\begin{figure}
  ...
  \caption{
\todo[inline]{This section needs to be rewritten}
%A galactic and isotropic diffuse subtracted 10 \gev to 100 \gev counts map of the region
%around 2FGL J1615.2-5138. The red star is the catalog position of 2FGL
%J1615.2-5138 and the red cross and the white circle are the best fit
%position and extension of this source assuming a uniform disk spatial
%model.  Overlaid on this plot are contours of this region as seen in \tev
%by H.E.S.S. This source spatially overlaps the extended H.E.S.S. source
%HESS J1614-518 (\cite{HESS_plane_survey}).  To fit this region, we had to
%relocalize the source 2FGL J1615.0-5051 from its catalog position (blue
%star) to its best fit position (blue cross) and add an additional source
%into the region at the position of the grey cross.  It is unclear of this
%is a physically new source or if 2FGL J1615.0-5051 is spatially extended.
%2FGL J1615.0-5051 is spatially coincident with the extended H.E.S.S.
%source HESS J1616-508 but was not found to be significantly extended
%using two years of data. Nevertheless, adding this addtional source
%was necessary to stop 2FGL J1615.2-5138's extension from growing too
%large and fitting both sources. To fit this region, we had to remove three catalog
%sources 2FGL J1619.7-5040c, 2FGL J1620.6-5111c, and 2FGL J1622.8-5006
%from the region because they were not significant. Two are shown as green
%stars and one is outside of the plot region.
  \todo[inline]{Describe this source better.}
...
\begin{figure}
  ...
  \todo[inline]{Describe the interpreation.}
...
\begin{figure}
  ...
  \todo[inline]{Describe the interpreation better.}
...
\begin{figure}
  ...
  \todo[inline]{Describe the interpreation
  better.} \todo[inline]{Note about why the top right source was not
  found to be extended b/c the scale is cut.}
...
\begin{figure}
  ...
  \todo[inline]{Describe interpreation better.} 
  }\label{Vela_Jr}
\end{figure}
