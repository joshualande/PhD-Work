...
figure~\ref{1FGL_J1613.6-5100c} are shown as the blue and XXXXXXXXXX\todo{what color} crosses
...
\begin{figure}
  \begin{center}
    ...
    a soruce is best for sources with size $~0.5\deg$. It also shows
    ...
    threshold to an extended source which is defiend as the flux when
