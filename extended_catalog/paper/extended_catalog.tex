...
Note that Wilk's Theorem only holds when the likelihood is maximized simultaneoulsy
fitting all of the parameters of model. It is for this reason why {\em pointlike}
goes through such great effort to simultaneously fit the position and extension of
a source.
...
and so so Wilk's Theorem does not hold\cite{Warnings about Wilk's Theorem Paper}.
