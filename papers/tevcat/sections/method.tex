...
%Je n'arrive pas à être clair ici. Peut-etre ai-je fait une erreur. Pour que l'analyse soit cohérente et ne pas avoir une source modélisée d'une sorte dans une région et d'une autre sorte dans une autre région, j'ai retourné l'analyse en fixant les sources voisines non pas aux morphologies du 1FHL mais aux morphologies que j'ai trouvé. Par exemple la région de 1632 1634 a été tournée une première fois en ayant 1640 et 1616 aux morphologies inclues dans le 1FHL. Puis j'ai fait retourner la région avec 1640 et 1616 modélisé par les templates TeV). 
