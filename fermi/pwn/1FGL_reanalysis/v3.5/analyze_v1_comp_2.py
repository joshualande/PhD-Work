...
renorm(roi)
if debug=="yes":
    print "-----------------------------------------------------First ROI Renormalized--------------------------------------------"
    print roi

if debug=="yes":
    print "-------------------------------------------Beginning the fit---------------------------------------------------"
roi.fit(method="simplex")

if debug=="yes":
    print "-----------------------------------------------------ROI after First fit--------------------------------------------"
    print roi

roi.fit(method="minuit",use_gradient=True)
if debug=="yes":
    print "-----------------------------------------------------ROI after Second fit--------------------------------------------"
    print roi
roi.fit(method="minuit",use_gradient=True)

if debug=="yes":
    print "-----------------------------------------------------ROI after last fit--------------------------------------------"
    print roi
...
if debug=="yes":
    print "-------------------------------------------Ploting Counts and model map---------------------------------------------------"
